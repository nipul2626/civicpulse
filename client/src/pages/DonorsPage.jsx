...
const NEEDS = [
    {
        ...
        location: "Dharavi North, Mumbai",
        families: 28,
        urgency: "Critical",
        funded: 72,
        volunteers: 3,
        description: "A cluster of 28 families in Dharavi North urgently need basic medical supplies including bandages, antiseptics, and ORS packets. The nearest clinic is 4km away.",
        ngoPartner: "Apnalaya Foundation",
        target: 15000,
        raised: 10800,
    },
    {
        ...
        category: "Food",
        emoji: "🍱",
        title: "Food Rations for Displaced Families",
        location: "Sion West, Mumbai",
        families: 34,
        urgency: "Critical",
        funded: 38,
        volunteers: 5,
        description: "34 families displaced after a building collapse are in immediate need of food rations. NGO partner can deploy within 2 hours of funding.",
    ...
    },
    {
        ...
        category: "Water",
        emoji: "💧",
        title: "Clean Water Tanker",
        location: "Mankhurd East, Mumbai",
        families: 80,
        urgency: "High",
        funded: 55,
        volunteers: 2,
        description: "Pipeline burst has left 80 families without clean water for 3 days. A tanker deployment costs ₹8,000 and can reach them by evening.",
        ngoPartner: "Pani Haq Samiti",
        target: 8000,
        raised: 4400,
    },
    {
        ...
        funded: 81,
        volunteers: 7,
        description: "18 families need tarpaulins and basic shelter materials after pre-monsoon roof damage. Almost funded — just ₹3,800 more needed.",
        ngoPartner: "SPARC India",
        target: 20000,
        raised: 16200,
    },
    {
        ...
        category: "Education",
        emoji: "📚",
        title: "School Supplies for 120 Children",
        location: "Chembur Colony, Mumbai",
        families: 120,
        urgency: "Medium",
        funded: 45,
        volunteers: 4,
        description: "120 children in Chembur Colony need notebooks, pens, and bags to continue schooling after their community school was damaged by flooding.",
        ngoPartner: "Pratham NGO",
        target: 30000,
        raised: 13500,
    },
    {
        ...
        category: "Medical",
        emoji: "💊",
        title: "Diabetes & BP Medicines",
        location: "Kurla East, Mumbai",
        families: 45,
        urgency: "Medium",
        funded: 29,
        volunteers: 1,
        description: "45 elderly residents in Kurla East have run out of chronic disease medications. A local health worker has compiled the list and is ready to purchase.",
        ngoPartner: "iCall Foundation",
        target: 12000,
        raised: 3480,
    },
];
...
const URGENCY_STYLES = {
    ...
    High: {
        light: { bg: "#FEF3C7", text: "#D97706", border: "#FDE68A" },
        dark: { bg: "#451a03", text: "#fbbf24", border: "#78350f" },
    },
    Medium: {
        light: { bg: "#ECFDF5", text: "#059669", border: "#A7F3D0" },
        dark: { bg: "#052e16", text: "#34d399", border: "#065f46" },
    },
};
...
function ImpactTicker({ dark }) {
    ...
    return (
        <div
            style={{
                background: dark ? "#0f1a0c" : "#1a2e13",
                borderTop: `2px solid ${dark ? "#78b450" : "#3D8A25"}`,
                borderBottom: `2px solid ${dark ? "#78b450" : "#3D8A25"}`,
                overflow: "hidden",
                padding: "10px 0",
                position: "relative",
            }}
        >
            ...
            <span>{item.icon}</span>
            <span style={{ color: item.urgent ? "#f87171" : "#a7f3d0", fontWeight: item.urgent ? 700 : 400 }}>
              {item.text}
            </span>
...
function NeedCard({ need, dark, onSupport }) {
    ...
    return (
        <motion.div
            whileHover={{ y: -4, boxShadow: dark ? "0 12px 40px rgba(120,180,80,0.15)" : "0 12px 40px rgba(61,138,37,0.12)" }}
        ...
        >
            {/* Top accent line by urgency */}
            <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "3px", background: urgencyStyle.text, opacity: 0.7 }} />

            {/* Header */}
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginTop: "4px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    <span style={{ fontSize: "22px" }}>{need.emoji}</span>
                    <div>
        ...
        <span style={{ fontSize: "12px", color: textSecondary, display: "flex", alignItems: "center", gap: "4px" }}>
          ...
          👨‍👩‍👧 {need.families} families
            ...
            <motion.button
                ...
                style={{
                    background: `linear-gradient(135deg, ${dark ? "#78b450" : "#3D8A25"}, ${dark ? "#5a9e3a" : "#2d6b1c"})`,
                    color: "#fff",
                    border: "none",
                    borderRadius: "10px",
                    padding: "10px 16px",
...
function SupportModal({ need, dark, onClose }) {
    ...
    return (
        <motion.div
            ...
            onClick={onClose}
            style={{
                position: "fixed", inset: 0, background: overlay, zIndex: 1000,
        ...
        >
            <motion.div
                ...
                style={{
                    ...
                    padding: "28px",
                    fontFamily: "'Outfit', sans-serif",
                    boxShadow: dark ? "0 24px 80px rgba(0,0,0,0.6)" : "0 24px 80px rgba(0,0,0,0.15)",
                }}
            >
                {!submitted ? (
                    <>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "20px" }}>
                            <div>
                                <div style={{ fontSize: "22px", marginBottom: "4px" }}>{need.emoji}</div>
                            ...
                            <button onClick={onClose} style={{ background: "none", border: "none", fontSize: "22px", cursor: "pointer", color: textSecondary, padding: "0 0 0 8px", lineHeight: 1 }}>✕</button>
                        </div>

                        {/* Description */}
                        <p style={{ fontSize: "14px", color: textSecondary, lineHeight: 1.6, marginBottom: "20px", margin: "0 0 20px" }}>
                            {need.description}
                        </p>
                        ...
                        <div style={{ background: dark ? "#111f0d" : "#f0f9eb", borderRadius: "12px", padding: "14px", marginBottom: "20px" }}>
                            ...
                            <div style={{ background: dark ? "#1e3318" : "#d4edcc", borderRadius: "99px", height: "8px", overflow: "hidden" }}>
                                <div style={{ width: `${need.funded}%`, height: "100%", background: green, borderRadius: "99px" }} />
                            </div>
                        </div>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "8px" }}>
                                {[100, 500, 1000].map(v => (
                                    <button
                                        ...
                                        style={{
                                            padding: "10px",
                                            borderRadius: "10px",
                                            border: `2px solid ${(!isCustom && amount === v) ? green : border}`,
                                            background: (!isCustom && amount === v) ? (dark ? "#1e3318" : "#f0f9eb") : "transparent",
                                            color: (!isCustom && amount === v) ? green : textSecondary,
                                            fontFamily: "'Outfit', sans-serif",
                                            fontWeight: 700,
                                            fontSize: "15px",
                                            cursor: "pointer",
                                ...
                                <button
                                    ...
                                    style={{
                                        padding: "10px",
                                        borderRadius: "10px",
                                        border: `2px solid ${isCustom ? green : border}`,
                                        background: isCustom ? (dark ? "#1e3318" : "#f0f9eb") : "transparent",
                                        color: isCustom ? green : textSecondary,
                                        fontFamily: "'Outfit', sans-serif",
                                        fontWeight: 700,
                                        fontSize: "14px",
                                        cursor: "pointer",
                        ...
                        <div style={{ marginBottom: "20px" }}>
                            <label style={{ display: "flex", alignItems: "center", gap: "10px", cursor: "pointer" }}>
                                ...
                                />
                                <span style={{ fontSize: "14px", color: textPrimary }}>I want updates on this need</span>
                            </label>
                            <AnimatePresence>
                                {wantsUpdates && (
                                    <motion.div
                        ...
                        {/* Impact promise */}
                        <div style={{
                            background: dark ? "#0a1a07" : "#f0f9eb",
                            border: `1px solid ${dark ? "#1e4018" : "#b8dba8"}`,
                            borderRadius: "12px",
                            padding: "14px",
                            marginBottom: "20px",
                            display: "flex",
                            ...
                            <div>
                                ...
                                <div style={{ fontSize: "12px", color: textSecondary, lineHeight: 1.5 }}>
                                    You'll receive a photo + impact report within 48 hours of the need being met, via {need.ngoPartner}.
                                </div>
                            </div>
                        </div>
                        ...
                        <div style={{ fontSize: "12px", color: dark ? "#4a7c35" : "#6a9e52", marginBottom: "20px", lineHeight: 1.5 }}>
                            🔒 Payments handled by our NGO partner <strong>{need.ngoPartner}</strong>. CivicPulse does not hold funds.
                        </div>
                        ...
                        <motion.button
                            ...
                            style={{
                                width: "100%",
                                padding: "14px",
                                background: finalAmount > 0 ? `linear-gradient(135deg, ${green}, ${dark ? "#5a9e3a" : "#2d6b1c"})` : (dark ? "#1e3318" : "#e5f0df"),
                                color: finalAmount > 0 ? "#fff" : textSecondary,
                                border: "none",
                                borderRadius: "12px",
                                fontFamily: "'Outfit', sans-serif",
                                fontWeight: 800,
                    ...
                    >
                        ...
                        <h2 style={{ fontSize: "24px", fontWeight: 800, color: green, margin: "0 0 10px" }}>Thank you!</h2>
                        <p style={{ fontSize: "15px", color: textSecondary, lineHeight: 1.6, margin: "0 0 20px" }}>
                            You're making a real difference for {need.families} families in {need.location}.{" "}
                            {wantsUpdates && email ? `Updates will arrive at ${email}.` : ""}
                        </p>
                        <div style={{ background: dark ? "#111f0d" : "#f0f9eb", borderRadius: "12px", padding: "16px", marginBottom: "20px" }}>
                            <div style={{ fontSize: "13px", color: textSecondary, marginBottom: "4px" }}>Your contribution</div>
                            <div style={{ fontSize: "28px", fontWeight: 800, color: green }}>₹{finalAmount.toLocaleString()}</div>
                            <div style={{ fontSize: "12px", color: dark ? "#4a7c35" : "#6a9e52", marginTop: "4px" }}>→ {need.ngoPartner} will receive this within 24 hours</div>
                        </div>
                        <button
                            onClick={onClose}
                            style={{
                                ...
                                padding: "10px 24px", fontFamily: "'Outfit', sans-serif",
...
function MapPreview({ dark }) {
    ...
    return (
        <div style={{
            background: bg,
            borderRadius: "16px",
            border: `1px solid ${dark ? "#1e3318" : "#c8e6b8"}`,
            padding: "20px",
            position: "relative",
            overflow: "hidden",
            minHeight: "220px",
            ...
            <svg style={{ position: "absolute", inset: 0, width: "100%", height: "100%", opacity: 0.4 }}>
                {[...Array(8)].map((_, i) => (
                    <line key={`h${i}`} x1="0" y1={`${(i + 1) * 12.5}%`} x2="100%" y2={`${(i + 1) * 12.5}%`} stroke={gridColor} strokeWidth="1" />
                ))}
                {[...Array(10)].map((_, i) => (
                    <line key={`v${i}`} x1={`${(i + 1) * 10}%`} y1="0" x2={`${(i + 1) * 10}%`} y2="100%" stroke={gridColor} strokeWidth="1" />
                ))}
            </svg>
            ...
            {MAP_ZONES.map((zone, i) => (
                ...
                >
                    {zone.active && (
                        <motion.div
                            ...
                            style={{
                                ...
                                height: zone.size + 12,
                                borderRadius: "50%",
                                background: zone.count > 2 ? "#ef4444" : "#f97316",
                                opacity: 0.3,
                                top: "50%",
                                left: "50%",
                                transform: "translate(-50%, -50%)",
                    ...
                    <div style={{
                        ...
                        height: zone.size,
                        borderRadius: "50%",
                        background: zone.count > 2 ? "#ef4444" : zone.count > 1 ? "#f97316" : "#78b450",
            ...
            <div style={{
                ...
                background: dark ? "#1e3318" : "#ffffff",
                border: `1px solid ${dark ? "#3D8A25" : "#c8e6b8"}`,
                borderRadius: "99px",
                padding: "4px 12px",
                fontSize: "12px",
                fontWeight: 700,
                color: dark ? "#78b450" : "#3D8A25",
                fontFamily: "'Outfit', sans-serif",
            }}>
                7 active zones
            </div>
...
export default function DonorsPage() {
    ...
    return (
        <div style={{ fontFamily: "'Outfit', sans-serif", background: bg, minHeight: "100vh", color: textPrimary, transition: "background 0.3s, color 0.3s" }}>
            {/* Google Font import */}
            <style>{`@import url('https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700;800;900&display=swap');*{box-sizing:border-box;margin:0;padding:0;}::-webkit-scrollbar{width:6px;}::-webkit-scrollbar-track{background:transparent;}::-webkit-scrollbar-thumb{background:${dark ? "#1e3318" : "#c8e6b8"};border-radius:3px;}`}</style>

            {/* ── NAVBAR ──────────────────────────────── */}
            <nav style={{
                position: "sticky", top: 0, zIndex: 100,
                background: dark ? "rgba(8,15,6,0.92)" : "rgba(245,250,242,0.92)",
                ...
                <Link to="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "8px" }}>
                    ...
                    <span style={{ fontWeight: 800, fontSize: "17px", color: textPrimary }}>CivicPulse</span>
                </Link>
                <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                    ...
                    <Link to="/dashboard" style={{ textDecoration: "none", fontSize: "14px", fontWeight: 500, color: textSecondary }}>Dashboard</Link>
                    <motion.button
                        whileTap={{ scale: 0.92 }}
                        onClick={() => setDark(d => !d)}
                        style={{
            ...
            {/* ── HERO ────────────────────────────────── */}
            <section style={{ padding: "64px 24px 48px", textAlign: "center", maxWidth: "860px", margin: "0 auto" }}>
                <motion.div
                ...
                >
                    {/* Live counter pill */}
                    <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", background: dark ? "#0d1a09" : "#e8f5e0", border: `1px solid ${dark ? "#1e3318" : "#b8dba8"}`, borderRadius: "99px", padding: "6px 16px", marginBottom: "24px" }}>
                        <motion.div
                            animate={{ opacity: [1, 0.3, 1], scale: [1, 1.3, 1] }}
                            transition={{ duration: 1.5, repeat: Infinity }}
                            style={{ width: "9px", height: "9px", borderRadius: "50%", background: "#22c55e" }}
                        />
                        <span style={{ fontSize: "13px", fontWeight: 700, color: green }}>
              {count} active needs right now
            </span>
                    </div>
              ...
              in hours
              <svg style={{ position: "absolute", bottom: "-4px", left: 0, width: "100%", height: "6px" }} viewBox="0 0 100 6" preserveAspectRatio="none">
                <path d="M0,5 Q50,0 100,5" stroke={green} strokeWidth="2" fill="none" opacity="0.5" />
              </svg>
            </span>
                        {" "}— not months
                    </h1>

                    <p style={{ fontSize: "18px", color: textSecondary, lineHeight: 1.6, maxWidth: "600px", margin: "0 auto 32px" }}>
                        Browse verified community needs. Every rupee is tracked in real time.
                    </p>
            ...
            {/* ── CURRENT NEEDS GRID ──────────────────── */}
            <section id="needs" style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 24px 64px" }}>
                {/* Filters */}
                        ...
                        {CATEGORIES.map(cat => (
                            <motion.button
                                ...
                                style={{
                                    padding: "7px 16px",
                                    borderRadius: "99px",
                                    border: `1px solid ${activeCategory === cat ? pillActive : border}`,
                                    background: activeCategory === cat ? pillActive : pillBg,
            ...
            <section style={{ background: dark ? "#0d1a09" : "#e8f5e0", borderTop: `1px solid ${border}`, borderBottom: `1px solid ${border}`, padding: "64px 24px" }}>
                <div style={{ maxWidth: "960px", margin: "0 auto" }}>
                    <div style={{ textAlign: "center", marginBottom: "48px" }}>
                        <h2 style={{ fontSize: "32px", fontWeight: 800, color: textPrimary, marginBottom: "10px" }}>How your donation flows</h2>
                        <p style={{ fontSize: "15px", color: textSecondary }}>100% of donations go to verified needs. The platform is grant-funded.</p>
                    </div>

                    {/* 3-step flow */}
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0", flexWrap: "wrap", marginBottom: "48px" }}>
                        {[
                            { icon: "💳", label: "You", sub: "Contribute any amount" },
                            { icon: "🤝", label: "NGO Partner", sub: "Receives & deploys funds" },
                            { icon: "👨‍👩‍👧", label: "Beneficiary", sub: "Gets help within hours" },
                        ].map((step, i) => (
                            <div key={i} style={{ display: "flex", alignItems: "center" }}>
                                ...
                                {i < 2 && (
                                    <motion.div
                                        animate={{ x: [0, 5, 0] }}
                                        transition={{ duration: 1.5, repeat: Infinity }}
                                        style={{ fontSize: "28px", color: green, margin: "0 8px" }}
                                    >
                                        →
                                    </motion.div>
                                )}
                    ...
                    {/* Sample impact report card */}
                    <div style={{ maxWidth: "480px", margin: "0 auto" }}>
                        <div style={{ fontSize: "13px", fontWeight: 700, color: textSecondary, textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "12px", textAlign: "center" }}>
                            Sample Impact Report (what you'll receive)
                        </div>
                        <div style={{
                            background: cardBg,
                            border: `1px solid ${dark ? "#2a4a20" : "#b8dba8"}`,
                            borderRadius: "16px",
                            overflow: "hidden",
                        }}>
                            ...
                            <div style={{ padding: "16px 20px" }}>
                                <div style={{ fontSize: "14px", color: textPrimary, lineHeight: 1.6, marginBottom: "14px" }}>
                                    34 families in Sion West received food rations today. Distribution was completed by 3:00 PM, 6 hours after funding was reached.
                                </div>
                                <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            ...
            <section style={{ maxWidth: "960px", margin: "0 auto", padding: "64px 24px" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "32px", alignItems: "center" }}>
                    <div>
                        <h2 style={{ fontSize: "28px", fontWeight: 800, color: textPrimary, marginBottom: "12px", lineHeight: 1.2 }}>
                            Needs are concentrated. Help is mapped.
                        </h2>
                        <p style={{ fontSize: "15px", color: textSecondary, lineHeight: 1.7, marginBottom: "20px" }}>
                            Our coordinators track every active zone across Mumbai in real time. 7 zones are currently active.
                        </p>
                        <Link
                            to="/dashboard"
                            style={{
                                ...
                                fontWeight: 700,
                                fontSize: "15px",
                                border: `1px solid ${dark ? "#1e3318" : "#b8dba8"}`,
                                borderRadius: "10px",
                                padding: "10px 18px",
                                background: dark ? "#0d1a09" : "#f0f9eb",
                            }}
                        >
                            Coordinators: View full live heatmap →
                        </Link>
                    </div>
            ...
            <section style={{ maxWidth: "960px", margin: "0 auto 64px", padding: "0 24px" }}>
                ...
                >
                    <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
                        ...
                        <div>
                            <div style={{ fontSize: "16px", fontWeight: 800, color: textPrimary }}>Are you a Coordinator?</div>
                            <div style={{ fontSize: "13px", color: textSecondary }}>Track donor activity, assign volunteers, and manage needs in real time.</div>
                        </div>
                    </div>
                    <Link
                        to="/dashboard"
                ...
                <div style={{ maxWidth: "960px", margin: "0 auto" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "24px", marginBottom: "24px" }}>
                        <div>
                            ...
                            <p style={{ fontSize: "13px", color: textSecondary, maxWidth: "240px", lineHeight: 1.6 }}>
                                CivicPulse is open-source. Built for impact, not profit.
                            </p>
                        </div>
                        <div style={{ display: "flex", gap: "24px", flexWrap: "wrap" }}>
                            {[
                                { label: "Home", to: "/" },
                                { label: "Report a Need", to: "/report" },
                                { label: "For Volunteers", to: "/volunteers" },
                                { label: "For NGOs", to: "/ngos" },
                                { label: "Dashboard", to: "/dashboard" },
                            ].map(link => (
                                <Link key={link.label} to={link.to} style={{ textDecoration: "none", fontSize: "14px", fontWeight: 500, color: textSecondary }}>
                                    {link.label}
                                </Link>
                            ))}
                        </div>
            ...
            <AnimatePresence>
                {selectedNeed && (
                    <SupportModal need={selectedNeed} dark={dark} onClose={() => setSelectedNeed(null)} />
                )}
            </AnimatePresence>
        </div>
    );
